...
const StepForm1 = () => {
  ...
  return (
   <main className="flex justify-center items-center
    h-screen xl nt:h-[550px] nt:rounded-[10px] nt:justify-between nt:px-5 ">
    <Steps stepLink={1} />
    <div className='card relative top-[20%] nt:relative nt:top-0  bg-base-100 w-[330px] rounded-[5px] 
    shadow-sm nt:bg-transparent nt:shadow-none nt:w-[500px] '>
       ...
       <div className='mt-5 flex justify-between fixed  bottom-0 
       nt:relative w-full bg-white nt:bg-transparent  left-0 p-3'>
